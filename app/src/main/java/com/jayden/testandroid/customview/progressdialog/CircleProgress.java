...
public class CircleProgress extends View {
    ...
    public CircleProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        min_size = (int) ConvertUtils.dipToPx(getContext(), 100);
    ...
    public String getDrawText() {
        return prefixText + progress + suffixText;
    }
...
//        canvas.drawArc(rectF, 90 - angle, angle * 2, false, paint);
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        bundle.putInt(INSTANCE_FINISHED_STROKE_COLOR, finishedColor);
        bundle.putInt(INSTANCE_UNFINISHED_STROKE_COLOR, unfinishedColor);
