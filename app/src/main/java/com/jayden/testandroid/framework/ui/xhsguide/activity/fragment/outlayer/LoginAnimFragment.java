...
import com.jayden.testandroid.framework.ui.xhsguide.activity.fragment.outlayer.loginlayer.LoginFragment;
import com.jayden.testandroid.framework.ui.xhsguide.activity.fragment.outlayer.loginlayer.RegisterFragment;
...
public class LoginAnimFragment extends Fragment {
    ...
    public void playInAnim(){
        ...
        ObjectAnimator anim3 = ObjectAnimator.ofFloat(rl_parent,
                "y", DvAppUtil.getDisplayMetrics(getActivity()).heightPixels, ConvertUtils.dipToPx(getActivity(), 160));
