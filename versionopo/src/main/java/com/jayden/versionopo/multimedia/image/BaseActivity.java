...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // init parameters
        complex = new Complex(0.285f, 0.01f);
    ...
    void drawBitmap(TextureView textureView, Rect r, Bitmap bitmap){
        if (isAvailable.get()){
            Canvas canvas = textureView.lockCanvas(new Rect(r));
            canvas.drawBitmap(bitmap, r.left, r.top, null);
    ...
    public Bitmap calculateBitmap(Rect r){
        return calculateBitmap(r, complex.re, complex.im);
    }

    private Bitmap calculateBitmap(Rect r, float re, float im) {
    ...
    private int generateColor(int k) {
        int r, g, b;
    ...
    public int getScreenWidth(Context context){
        WindowManager manager = (WindowManager) context.getApplicationContext().getSystemService(WINDOW_SERVICE);
