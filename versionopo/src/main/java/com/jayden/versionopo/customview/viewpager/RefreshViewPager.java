package com.jayden.versionopo.customview.viewpager;
...
public class RefreshViewPager extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_refresh_pager);
