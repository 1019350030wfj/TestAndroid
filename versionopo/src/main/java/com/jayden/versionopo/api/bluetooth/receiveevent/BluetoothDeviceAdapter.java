...
public class BluetoothDeviceAdapter extends BaseAdapter {
    ...
    public BluetoothDeviceAdapter(List<BluetoothDevice> mList, Context mContext) {
        this.mList = mList;
    ...
    private void initData(int position,ViewHolder viewHolder) {
        ...
        viewHolder.bluehandlename.setText(bluetoothDevice.getName()+":"+bluetoothDevice.getAddress());
