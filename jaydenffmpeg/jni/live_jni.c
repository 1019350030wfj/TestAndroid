...
/**
*   编码函数
*   avcodec_encode_video2 被deprecated后，自己封装的
*/
...
Java_com_jayden_jaydenffmpeg_MainActivity_helloFromFFmpeg(JNIEnv *env, jobject instance) {
...
Java_com_jayden_jaydenffmpeg_LiveActivity_streamerRelease(JNIEnv *env, jobject instance) {
...
JNIEXPORT jint JNICALL
Java_com_jayden_jaydenffmpeg_LiveActivity_streamerFlush(JNIEnv *env, jobject instance) {
...
JNIEXPORT jint JNICALL
Java_com_jayden_jaydenffmpeg_LiveActivity_streamerHandle(JNIEnv *env, jobject instance,
                                                   jbyteArray data_) {
...
JNIEXPORT jint JNICALL
Java_com_jayden_jaydenffmpeg_LiveActivity_streamerInit(JNIEnv *env, jobject instance, jint width,
                                                 jint height) {

    // TODO
    int ret = 0;
    const char *address = "rtmp://192.168.3.131/oflaDemo/test";
